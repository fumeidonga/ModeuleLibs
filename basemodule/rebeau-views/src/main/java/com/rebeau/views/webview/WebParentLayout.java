...
public class WebParentLayout extends FrameLayout {
	...
	public WebParentLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
		...
		mWebViewprogressbar.setLayoutParams(new AbsoluteLayout.LayoutParams(AbsoluteLayout.LayoutParams.FILL_PARENT, RBScreenUtil.getInstance().dip2px(1), 0, 0));
		mWebViewprogressbar.setProgressDrawable(context.getResources().getDrawable(R.drawable.rb_layout_list_progress));
