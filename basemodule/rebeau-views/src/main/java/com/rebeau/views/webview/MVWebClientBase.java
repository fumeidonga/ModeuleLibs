 ...
 *
 */
public class MVWebClientBase extends WebViewClient {
    private MVWebClientBase mMiddleWrareWebClientBase;

    public MVWebClientBase(MVWebClientBase client) {
        this.mMiddleWrareWebClientBase = client;
    }

    protected MVWebClientBase(WebViewClient client) {
        this.mDelegate = client;
    }

    protected MVWebClientBase() {
    }

    public final MVWebClientBase next() {
    ...
    public final MVWebClientBase enq(MVWebClientBase middleWrareWebClientBase) {
