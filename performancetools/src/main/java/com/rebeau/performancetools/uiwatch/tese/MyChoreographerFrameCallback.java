package com.rebeau.performancetools.uiwatch.tese;
 ...
 */
public class MyChoreographerFrameCallback implements Choreographer.FrameCallback {
    protected final String TAG = "MyFrameCallback";
    ...
    private static MyChoreographerFrameCallback sInstance;
    ...
    private MyChoreographerFrameCallback() {
        mSkipRecordMap = new HashMap<>();
        mActivityShowTimeMap = new HashMap<>();
    }

    public static MyChoreographerFrameCallback getInstance() {
        if (sInstance == null) {
            sInstance = new MyChoreographerFrameCallback();
        }
        return sInstance;
    }
    ...
    public void start() {
        Choreographer.getInstance().postFrameCallback(MyChoreographerFrameCallback.getInstance());
    }
