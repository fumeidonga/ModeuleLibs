 ...
 * tab 关联viewpager实现
 */
public abstract class BaseTopSegmentTabVPFragment extends BaseAppFragment {
    ...
    protected View createSuccessView(@Nullable ViewGroup container) {
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.base_tab_top_segment_view_pager_fragment_layout, container, false);
