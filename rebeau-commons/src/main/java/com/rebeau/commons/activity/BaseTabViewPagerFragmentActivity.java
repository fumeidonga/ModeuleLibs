 ...
 * tab 关联viewpager实现
 */
public abstract class BaseTabViewPagerFragmentActivity extends BaseFragmentActivity {
    ...
    protected View createSuccessView() {
        View view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.base_tab_view_pager_fragment_layout, null);
