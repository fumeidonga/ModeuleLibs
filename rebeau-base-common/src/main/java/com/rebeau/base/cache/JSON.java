...
//		RBLogUtil.i(TAG, "isJsonCorrect  <<<<     " + s + "     >>>>>>>");
		if (s == null || s.equals("[]") 
	...
	public static JSONObject parseObject(String json) {
		try {
			...
			RBLogUtil.e(TAG, "parseObject  catch \n" + e.getMessage());
		}
		return null;
	}
	...
	public static String toJSONString(Object obj) {
		...
		try {
			...
			RBLogUtil.e(TAG, "toJSONString  catch \n" + e.getMessage());
		}
		return null;
	}
	...
	public static JSONArray parseArray(String json) {
		try {
			...
			RBLogUtil.e(TAG, "parseArray  catch \n" + e.getMessage());
		}
		return null;
	}
	/**
	...
	public static boolean isJSONObject(Object obj) {
		...
		if (obj instanceof String) {
			try {
				...
				RBLogUtil.e(TAG, "isJSONObject  catch \n" + e.getMessage());
			}
		}
	...
	public static boolean isJSONArray(Object obj) {
		...
		if (obj instanceof String) {
			try {
				...
				RBLogUtil.e(TAG, "isJSONArray  catch \n" + e.getMessage());
			}
		}
