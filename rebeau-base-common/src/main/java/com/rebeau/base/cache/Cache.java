...
public class Cache<T> {
	...
	public void saveList(Map<String, T> map) {
		if (map == null) {
			RBLogUtil.e(TAG, "saveList  map == null >> return;");
			return;
		}
	...
	public void save(String key, T value) {
		if (StringUtil.isNotEmpty(key, true) == false || value == null) {
			RBLogUtil.e(TAG, "save StringUtil.isNotEmpty(key, true) == false || value == null >> return;");
			return;
		}
	...
	public boolean isContain(String key) {
		if (StringUtil.isNotEmpty(key, true) == false) {
			RBLogUtil.e(TAG, "isContain StringUtil.isNotEmpty(key, true) == false >> return false;");
			return false;
		}
	...
	public Map<String, String> getMap() {
		try {
			...
			RBLogUtil.e(TAG, "getMap try { return (Map<String, String>) sp.getAll();" +
					"}catch(Exception e) {\n " + e.getMessage());
		}
		return null;
	}
	...
	public void remove(String key) {
		if (StringUtil.isNotEmpty(key, true) == false) {
			RBLogUtil.e(TAG, "deleteGroup  context == null " +
